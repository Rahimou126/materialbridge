...
class AppTheme {
  ...
  // Industrial B2B Professional Depth Palette
  ...
  static const Color accentLight =
      Color(0xFFE67E22); // Warm orange for urgent notifications
  ...
  static const Color warningLight = Color(0xFFF39C12); // Amber for caution
  ...
  static const Color borderLight = Color(0xFFE8ECEF); // Subtle gray for borders

  // Dark theme colors (adapted for professional use)
  static const Color primaryDark =
      Color(0xFF4A90A4); // Supporting blue becomes primary
  static const Color primaryVariantDark = Color(0xFF357A8F);
  ...
  static const Color accentDark =
      Color(0xFFE67E22); // Same accent for consistency
  ...
  // Shadow colors with specified opacity (0.08 for professional appearance)
  ...
  static ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
      ...
      elevation: 2.0, // Subtle elevation for professional appearance
    ...
    floatingActionButtonTheme: FloatingActionButtonThemeData(
      ...
      elevation: 4.0, // 4dp shadow for floating elements
      shape: RoundedRectangleBorder(
    ...
    bottomSheetTheme: const BottomSheetThemeData(
      backgroundColor: surfaceLight,
      elevation: 8.0, // 8dp shadow for modal elements
      shape: RoundedRectangleBorder(
  ...
  static TextTheme _buildTextTheme({required bool isLight}) {
    ...
    return TextTheme(
      ...
      // Title styles - Inter Medium/SemiBold
  ...
  /// Helper method to get data text style (JetBrains Mono for technical specifications)
  ...
  /// Helper method to get medium data text style
  static TextStyle getMediumDataTextStyle({
    required bool isLight,
    double fontSize = 14,
  }) {
    return getDataTextStyle(
      isLight: isLight,
      fontSize: fontSize,
      fontWeight: FontWeight.w500,
    );
